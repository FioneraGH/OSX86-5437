 ...
 *
 * Disassembly of SSDT7.aml, Mon Dec 25 18:31:03 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000019B2 (6578)
 *     Revision         0x01
 *     Checksum         0x8E
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.ECNV, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.LPCB.EC__.FBST, MethodObj)    // 0 Arguments
    ...
    External (_SB_.PCI0.RP05.PEGP.SGPI, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.RP05.PEGP.SGPO, MethodObj)    // 2 Arguments
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        CreateDWordField (BUFF, 0x04, BUF2)
        CreateDWordField (BUFF, 0x08, BUF3)
        CreateDWordField (BUFF, 0x0C, BUF4)
        CreateDWordField (BUFF, 0x10, BUF5)
        CreateDWordField (BUFF, 0x14, BUF6)
        CreateDWordField (BUFF, 0x18, BUF7)
        CreateDWordField (BUFF, 0x1C, BUF8)
        Name (CTXT, Zero)
        Method (_ON, 0, Serialized)  // _ON_: Power On
        {
            ...
            If ((GPRF != One))
            {
                PCIC = BUF1 /* \_SB_.PCI0.RP05.PEGP.BUF1 */
                GMM1 = BUF2 /* \_SB_.PCI0.RP05.PEGP.BUF2 */
                GMM2 = BUF3 /* \_SB_.PCI0.RP05.PEGP.BUF3 */
                GMM3 = BUF4 /* \_SB_.PCI0.RP05.PEGP.BUF4 */
                GIO1 = BUF5 /* \_SB_.PCI0.RP05.PEGP.BUF5 */
                GIRQ = BUF6 /* \_SB_.PCI0.RP05.PEGP.BUF6 */
                SID = BUF7 /* \_SB_.PCI0.RP05.PEGP.BUF7 */
            }
        ...
        Method (_OFF, 0, Serialized)  // _OFF: Power Off
        {
            ...
            If ((GPRF != One))
            {
                If ((CTXT == Zero))
                {
                    BUF1 = PCIC /* \_SB_.PCI0.RP05.PEGP.PCIC */
                    BUF2 = GMM1 /* \_SB_.PCI0.RP05.PEGP.GMM1 */
                    BUF3 = GMM2 /* \_SB_.PCI0.RP05.PEGP.GMM2 */
                    BUF4 = GMM3 /* \_SB_.PCI0.RP05.PEGP.GMM3 */
                    BUF5 = GIO1 /* \_SB_.PCI0.RP05.PEGP.GIO1 */
                    BUF6 = GIRQ /* \_SB_.PCI0.RP05.PEGP.GIRQ */
                    BUF7 = SID /* \_SB_.PCI0.RP05.PEGP.SID_ */
                    CTXT = One
                }
            }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    \_PR.CPU0._PPC = PCAP /* \_SB_.PCI0.RP05.PEGP.GPS_.PCAP */
                ...
                Case (0x26)
                {
                    ...
                    \_PR.CPU0._PTC = TCAP /* \_SB_.PCI0.RP05.PEGP.GPS_.TCAP */
                    Notify (\_PR.CPU0, 0x80) // Status Change
                    Return (TCAP) /* \_SB_.PCI0.RP05.PEGP.GPS_.TCAP */
                }
                Case (0x2A)
                {
                    Debug = "GPS fun 2a"
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            \_SB.PCI0.RP05.PEGP.SGPO (HLRS, One)
            \_SB.PCI0.RP05.PEGP.SGPO (PWEN, One)
            Local0 = Zero
            While ((Local0 < 0x50))
            {
                Local0 += One
            ...
            \_SB.PCI0.RP05.PEGP.SGPO (HLRS, Zero)
        ...
        {
            If ((\_SB.PCI0.RP05.PEGP.SGPI (PWOK) == One))
            {
                Debug = "<<< GETS() return 0x1 >>>"
                Return (One)
            }
            ElseIf ((\_SB.PCI0.LPCB.EC.FBST () == One))
            {
    ...
    Scope (\_SB.PCI0.RP05)
    {
        Method (_DSW, 3, NotSerialized)  // _DSW: Device Sleep Wake
        {
            If (Arg1)
            {
                Debug = "RP05 -_DSW call "
            }
            ElseIf ((Arg0 && Arg2))
            {
                Debug = "RP05 -_DSW call-1 "
            }
            Else
            {
                Debug = "RP05 -_DSW call-2 "
            }
        }
    }
